...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val etNome = findViewById<EditText>(R.id.inputText)
        ...
        // Próximos passos:
        // 1. Aprender mais sobre as arquiteturas: MVM e MVVM
        // 2. Aprender sobre o Ciclo de Vida de Activity e da Aplicação
        // 3. Desenvolver um mini projeto com apelo visual que envolva o consumo de uma WebService
        // Ler o Livro: https://github.com/FabricaDeSinapse/livro-android-casa-do-codigo/
    }
}